...
def main():
    ...
    try:
        ...
        df_country_wise = pd.read_csv('../covid/dataset_clean/country_wise_latest_clean.csv')
        df_full_grouped = pd.read_csv('../covid/dataset_clean/full_grouped_clean.csv')
        df_worldometer = pd.read_csv('../covid/dataset_clean/worldometer_data_clean.csv')
        df_complete = pd.read_csv('../covid/dataset_clean/covid_19_clean_complete_clean.csv')
        df_counties = pd.read_csv('../covid/dataset_clean/usa_county_wise_clean.csv')
