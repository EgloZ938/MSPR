    ...
    <div class="country-selector-custom">
      ...
      <div class="dropdown-container" id="countriesDropdown" :class="{ 'active': isDropdownActive }">
        <div class="search-container">
          <input type="text" id="countrySearch" placeholder="Rechercher un pays..." class="search-input" v-model="searchTerm" @click.stop>
        </div>
        <div class="countries-list" id="countriesList">
          <div v-for="country in filteredCountries" :key="country.country_name" class="country-item" :class="{ 'selected': country.country_name === selectedCountry }" @click="selectCountry(country.country_name)">
